...
const getTurtles = (request, response) => {
  pool.query(
    'SELECT * FROM turtle WHERE is_deleted = false ORDER BY id',
    (error, results) => {
      if (error) {
        console.error(error);
      }
...
const getTurtleById = (request, response) => {
  ...
  pool.query(
    'SELECT * FROM turtle WHERE id = $1 AND is_deleted = false',
    [id],
    (error, results) => {
      if (error) {
        console.error(error);
...
const createTurtle = (request, response) => {
  ...
  pool.query(
    'INSERT INTO turtle (turtle_number, mark, sex) VALUES ($1, $2, $3) RETURNING id',
    [number, mark, sex],
    (error, results) => {
      if (error) {
        console.error(error);
...
const deleteTurtle = (request, response) => {
  ...
  pool.query(
    'UPDATE turtle SET is_deleted = true WHERE id = $1',
    [id],
    (error, results) => {
      if (error) {
        console.error(error);
        ...
        pool.query(
          'UPDATE sighting SET is_deleted = true WHERE turtle_id = $1',
          [id],
          (error, results) => {
            if (error) {
              console.error(error);
              ...
              pool.query(
                'UPDATE photo SET is_deleted = true WHERE turtle_id = $1',
                [id],
                (error, results) => {
                  if (error) {
                    console.error(error);
...
const getSightings = (request, response) => {
  pool.query(
    'SELECT * FROM sighting WHERE is_deleted = false ORDER BY time_seen DESC',
    (error, results) => {
      if (error) {
        console.error(error);
      }
...
const getSightingById = (request, response) => {
  ...
  pool.query(
    'SELECT * FROM sighting WHERE id = $1 AND is_deleted = false',
    [id],
    (error, results) => {
      if (error) {
        console.error(error);
...
const deleteSighting = (request, response) => {
  ...
  pool.query(
    'UPDATE sighting SET is_deleted = true WHERE id = $1',
    [id],
    (error, results) => {
      if (error) {
        console.error(error);
        ...
        pool.query(
          'UPDATE photo SET is_deleted = true WHERE sighting_id = $1',
          [id],
          (error, results) => {
            if (error) {
              console.error(error);
...
const getSightingByTurtleId = (request, response) => {
  ...
  pool.query(
    'SELECT * FROM turtle, sighting WHERE turtle.id = turtle_id AND turtle_id = $1 AND turtle.is_deleted = false AND sighting.is_deleted = false ORDER BY time_seen DESC',
    [turtleId],
    (error, results) => {
      if (error) {
        console.error(error);
...
const getRecentSightings = (request, response) => {
  pool.query(
    'SELECT DISTINCT ON (turtle_id) turtle_id, time_seen, latitude, longitude FROM sighting ORDER BY turtle_id, time_seen DESC',
    (error, results) => {
      if (error) {
        console.error(error);
      }
...
const getPhotos = (request, response) => {
  pool.query(
    'SELECT * FROM photo WHERE is_deleted = false',
    (error, results) => {
      if (error) {
        console.error(error);
      }
...
const getPhotoById = (request, response) => {
  ...
  pool.query(
    'SELECT * FROM photo WHERE id = $1 AND is_deleted = false',
    [id],
    (error, results) => {
      if (error) {
        console.error(error);
...
const createPhoto = (request, response) => {
  ...
  pool.query(
    'INSERT INTO photo (turtle_id, sighting_id, name) VALUES ($1, $2, $3) RETURNING id',
...
const deletePhoto = (request, response) => {
  ...
  pool.query(
    'UPDATE photo SET is_deleted = true WHERE id = $1',
    [id],
    (error, results) => {
      if (error) {
        console.error(error);
...
const getPhotoByTurtleId = (request, response) => {
  ...
  pool.query(
    'SELECT photo.name FROM turtle, photo WHERE turtle.id = turtle_id AND turtle_id = $1 AND turtle.is_deleted = false AND photo.is_deleted = false',
    [turtleId],
    (error, results) => {
      if (error) {
        console.error(error);
...
const getPhotoBySightingId = (request, response) => {
  ...
  pool.query(
    'SELECT photo.id, photo.name FROM sighting, photo WHERE sighting.id = sighting_id AND sighting_id = $1 AND sighting.is_deleted = false AND photo.is_deleted = false',
    [sightingId],
    (error, results) => {
      if (error) {
        console.error(error);
...
const sendEmail = (request, response) => {
  ...
  pool.query(
    'SELECT turtle_number, mark, sex, time_seen, turtle_location, latitude, longitude, carapace_length, notes FROM turtle, sighting WHERE turtle.id = sighting.turtle_id AND turtle.is_deleted = false AND sighting.is_deleted = false ORDER BY turtle_number',
    async (error, results) => {
      if (error) {
        console.log(error);
        throw error;
